    ...
    public class HandleTagHtml
    {
        ...
        public async Task<Image?> GetImage(string? type, IElement? data)
        {
            ...
            if (type == Constants.TYPE_WRAP_NOTE)
            {
                ...
                query = string.Format(Constants.LINK_TWO_TAG, typeTag, Constants.TAG_DIV_IMG);
            }
            else if (type == Constants.LAYOUT_ALBUM)
            {
        ...
        public async Task<Root> GetRoot(int? index, string? type, IElement? data)
        {
            ...
            string queryQuote = string.Format(Constants.LINK_TWO_TAG, queryType, Constants.TAG_DIV_P_QUOTE);
        ...
        public async Task<List<Root>> GetListRoot(int? index, IElement data, string query)
        {
            ...
            var queryConcat = string.Format(Constants.LINK_TWO_TAG, query, Constants.DIV_ATTR_TYPE);
